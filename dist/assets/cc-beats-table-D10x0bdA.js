const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/cc-create-modal-C-98--jd.js","assets/cc-config-B-Q2_xur.js","assets/cc-edit-modal-C6exXElq.js","assets/index-DpDIV0ue.js","assets/index-Cd_xDMKo.css"])))=>i.map(i=>d[i]);
import{_ as y}from"./index-DpDIV0ue.js";import{d as c,B as h,e as w,f as b}from"./cc-config-B-Q2_xur.js";let s=30,a=[],r=null;async function C(t){t&&(t.innerHTML=`
