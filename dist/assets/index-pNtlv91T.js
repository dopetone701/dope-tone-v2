...
<a href="#/vault?tab=free" data-route="vault?tab=free">Free Tools</a>
  ...
  </div>`;function o(){var c,h,f,w,g;return String(((c=window.__CURRENT_BEAT__)==null?void 0:c.id)||((g=(w=(h=window.DTPlayer)==null?void 0:h.queue)==null?void 0:w[(f=window.DTPlayer)==null?void 0:f.index])==null?void 0:g.id)||"")}function i(){var v,k;const c=((v=window.DTPlayer)==null?void 0:v.queue)||[],h=o(),f=((k=window.DTPlayer)==null?void 0:k.index)??0,w=document.getElementById("rightContent"),g=document.getElementById("queueCount");if(!w)return;if(g&&(g.textContent=`${c.length} tracks`),!c.length){w.innerHTML='<div style="color:#9CA3AF;font-size:13px;padding:20px;text-align:center">No queue</div>';return}w.innerHTML=c.map((L,z)=>{const _=String(L.id)===h||!h&&z===f,H=_&&window.__DT_AUDIO__&&!window.__DT_AUDIO__.paused;return`
